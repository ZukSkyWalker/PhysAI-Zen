---
layout: post
title: "IsingGPT – Transformer Learns Phase Transitions"
date: 2025-12-01
author: ZukSkyWalker
...
### 1.2 Phase Transition (in infinite 1D: none; but crossover exists)
...
### 1.3 Analytical Solution: 1D Ising Chain (Zero Field)
...
## 2. Algorithm: Metropolis-Hastings Sampling
...
## 3. ML Narrative: Transformer as Boltzmann Distribution Learner
...
### 3.4 Quantitative Verification: Theory vs. Transformer
...
### 4.2 The Transfer Matrix Connection
...
### 4.3 Attention as a Boltzmann weight
...
## 6. Try It Yourself: Verification Experiments

Want to see this in action? Here are concrete experiments you can run:

### 6.1 Experiment 1: Measure Nearest-Neighbor Correlation
...
### 6.2 Experiment 2: Plot Attention vs. Correlation Function
...
### 6.3 Experiment 3: Temperature Sweep
...
### 6.4 Experiment 4: Add External Field
